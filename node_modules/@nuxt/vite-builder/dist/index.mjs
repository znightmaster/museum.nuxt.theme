...
import { bundlerDiagnostics, createIsIgnored, directoryToURL, getLayerDirectories, logger, resolveAlias, resolvePath, setBuildOutput, tryUseNuxt, useNitro, useNuxt } from "@nuxt/kit";
