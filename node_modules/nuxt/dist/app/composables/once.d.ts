//#region src/app/composables/once.d.ts
 ...
 * @since 3.9.0
 */
declare function callOnce(key?: string, fn?: (() => any | Promise<any>), options?: CallOnceOptions): Promise<void>;
declare function callOnce(fn?: (() => any | Promise<any>), options?: CallOnceOptions): Promise<void>;
//#endregion
export { callOnce };